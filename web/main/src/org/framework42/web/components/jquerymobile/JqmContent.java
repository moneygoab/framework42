...
public class JqmContent extends HtmlComponent {

    private Builder builder;

    public JqmContent(Builder builder) {
    ...
    public static class Builder extends EventComponentBuilder<JqmContent> implements HtmlComponentStorage<HtmlComponent> {
        ...
        @Override
        public JqmContent build() {
            return new JqmContent(this);
        }
