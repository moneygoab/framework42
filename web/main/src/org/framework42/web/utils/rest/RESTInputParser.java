...
public enum RESTInputParser {
    ...
    public JSONObject parseInDataAllowEmpty(HttpServletRequest req, HttpServletResponse resp, APIResponseType responseType) throws IOException, StopServletExecutionException {
    ...
    public JSONArray parseInDataArrayAllowEmpty(HttpServletRequest req, HttpServletResponse resp, APIResponseType responseType) throws StopServletExecutionException, IOException {
