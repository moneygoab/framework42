...
public abstract class PageLogic<T extends UserSession, R extends PageModel> {
    ...
    public abstract R perform(HttpServletRequest req, HttpServletResponse resp, T session) throws IOException, StopServletExecutionException, ManageablePageException;
