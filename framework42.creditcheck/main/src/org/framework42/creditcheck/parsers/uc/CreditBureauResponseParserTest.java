...
public enum CreditBureauResponseParserTest {
    ...
    public CreditBureauApplicationResponse createCreditBureauResponse(UcReply reply, String governmentId) {
        ...
        try {
            incomeGroup = BaseParserTest.INSTANCE.findResponseGroup(reply, "W491", 0);
        ...
        try {
            Group sumGroup = BaseParserTest.INSTANCE.findResponseGroup(reply, "W611", 0);
        ...
        try {
            Group sumGroup = BaseParserTest.INSTANCE.findResponseGroup(reply, "W640", 0);
