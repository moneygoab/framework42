...
public enum CreditBureau {
    ...
    UC(1, Country.SWEDEN), EMULATOR_SWEDEN(2, Country.SWEDEN), INTERNAL(3, Country.SWEDEN), UC_MICRO(4, Country.SWEDEN), UC_TEST(5, Country.SWEDEN), INTENRAL_MICRO(6, Country.SWEDEN), INTERNAL_INVENTORY_FINANCING(7, Country.SWEDEN),
    EXTERNAL_APPLICATION(8, Country.SWEDEN),
