...
public enum ApplicationChannel {
    ...
    NONE(0), INTERNET(1), PHONE(2), LETTER(3), DIRECT_MARKETING(4), TELEPHONE_MARKETING(5), COMPRICER(6), CREDIT_FINDER(11), FREEDOM_FINANCE(12), MYLOAN(14), ADVISA(13), EMAIL(7),
