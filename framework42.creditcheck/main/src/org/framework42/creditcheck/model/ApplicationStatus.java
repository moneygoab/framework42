...
public enum ApplicationStatus {
    ...
    INFORMATION_GATHERING_PROCESS(1), APPROVAL_PROCESS(2), AWAITING_OFFER_ANSWER(7), ESIGNED(8), AGREEMENT_PROCESS(3), REGISTRATION_PROCESS(4), COMPLETED(5), CANCELLED(6);
