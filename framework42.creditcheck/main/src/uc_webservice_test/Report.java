...
public class Report {
    ...
    @XmlAttribute(name = "id", namespace = "http://www.uc.se/schemas/ucOrderReply/", required = true)
    protected String id;
    @XmlAttribute(name = "name", namespace = "http://www.uc.se/schemas/ucOrderReply/", required = true)
    protected String name;
    @XmlAttribute(name = "styp", namespace = "http://www.uc.se/schemas/ucOrderReply/", required = true)
    protected String styp;
    @XmlAttribute(name = "index", namespace = "http://www.uc.se/schemas/ucOrderReply/", required = true)
    protected String index;
    @XmlAttribute(name = "lagomid", namespace = "http://www.uc.se/schemas/ucOrderReply/")
    protected String lagomid;
    @XmlAttribute(name = "lagomlopnr", namespace = "http://www.uc.se/schemas/ucOrderReply/")
