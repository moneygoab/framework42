...
public class OriginalDocuments {
    ...
    @XmlAttribute(name = "altCertificate", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
    protected Boolean altCertificate;
    @XmlAttribute(name = "articlesOfAssociation", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
    protected Boolean articlesOfAssociation;
    @XmlAttribute(name = "certificate", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
    protected Boolean certificate;
    @XmlAttribute(name = "shareholdersMeetingProtocol", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
