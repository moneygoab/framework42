...
public class RetrieveLagomReport {
    ...
    @XmlAttribute(name = "datastoreid", namespace = "http://www.uc.se/schemas/ucOrderRequest/", required = true)
    protected String datastoreid;
    @XmlAttribute(name = "objectid", namespace = "http://www.uc.se/schemas/ucOrderRequest/", required = true)
    protected String objectid;
    @XmlAttribute(name = "sequenceNr", namespace = "http://www.uc.se/schemas/ucOrderRequest/", required = true)
