 ...
 *       &lt;attribute name="pdfReply" type="{http://www.w3.org/2001/XMLSchema}boolean" />
...
public class ReportQuery {
    ...
    @XmlAttribute(name = "xmlReply", namespace = "http://www.uc.se/schemas/ucOrderRequest/", required = true)
    protected boolean xmlReply;
    @XmlAttribute(name = "htmlReply", namespace = "http://www.uc.se/schemas/ucOrderRequest/", required = true)
    protected boolean htmlReply;
    @XmlAttribute(name = "reviewReply", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
    protected Boolean reviewReply;
    @XmlAttribute(name = "pdfReply", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
    protected Boolean pdfReply;
    @XmlAttribute(name = "extendedDetails", namespace = "http://www.uc.se/schemas/ucOrderRequest/")
     ...
     *     
     */
    public void setPdfReply(Boolean value) {
        this.pdfReply = value;
    }
