...
public enum Role implements Serializable {
    ...
    ACCOUNTING_MANAGER(25, "ACCOUNTING_MANAGER"), AGREEMENT_VIEWER(26, "AGREEMENT_VIEWER"),REPRESENTATIVE_CUSTOMER_SERVICE(27,"REPRESENTATIVE_CUSTOMER_SERVICE"),

    /* End user roles */
    MEMBER(100, "MEMBER"), VIP_MEMBER(101, "VIP_MEMBER"), NEW_MEMBER(102, "NEW_MEMBER"), MEMBER_NOT_VERIFIED(103, "MEMBER_NOT_VERIFIED"),
    NAME_CHANGED(104, "NAME_CHANGED"),DECEASED(105, "DECEASED"),
    POWER_MEMBER_1(110, "POWER_MEMBER_1"),
