...
public class Majestic12BotParserImpl implements UserAgentEngineParser {

    public Majestic12BotParserImpl() {
    }
    ...
    private float parseVersion(String name, String userAgent, Logger logger) {
        ...
        if(cut.length>1) {
            ...
            try {
                ...
                logger.error("[useragent_detection] Majestic12BotParserImpl couldn't parse version from UserAgent: "+userAgent);
            }
