...
public abstract class FormListener<T extends UserSession, R extends PageModel> {
    ...
    public void tryFormEvent(String currentFormEventId, HttpServletRequest req, HttpServletResponse resp, T session, R pageModel) {
    ...
    protected abstract void handleFormEvent(HttpServletRequest req, HttpServletResponse resp, T session, R pageModel);
